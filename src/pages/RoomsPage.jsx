    ...
    return (
        <>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-base-100 dark:bg-dark-base-200 rounded-2xl shadow-lg">
                    <h3 className="text-xl font-semibold">No Rooms Found</h3>
                    <p className="text-base-content-secondary mt-2">Add a room to get started.</p>
                </div>
            )}
